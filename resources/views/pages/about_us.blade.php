        ...
        <section class="container g-pt-100 g-pb-50">
            ...
            <div class="row">
                <div class="col-lg-6 g-mb-50">
                    <img class="img-fluid" src="../../assets/img-temp/1000x440/img1.png" alt="Image Description">
                </div>
                <div class="col-lg-6">
                    <div class="mb-5">
                ...
                <div class="col-lg-9">
                    ...
                    <article class="u-shadow-v21 g-bg-size-cover g-bg-pos-bottom-center text-center" style="background-image: url(../../assets/img-temp/900x600/img7.jpg);">
                        <div class="g-pos-rel g-z-index-1 g-px-50 g-py-200">
                            <a class="js-fancybox d-block" href="http://www.youtube.com/embed/BNpiwOkKIJ8?autoplay=1" title="Single Image">
